...
export const SERVICES: ServiceData[] = [
  {
    ...
    heroImage: NWS_IMAGES.customHome,
    galleryImages: [
  ...
  },
  {
    ...
    heroImage: NWS_IMAGES.additionAfter,
    galleryImages: [
      NWS_IMAGES.additionAfter,
  ...
  },
  {
    ...
    heroImage: NWS_IMAGES.remodelLiving,
    galleryImages: [
      NWS_IMAGES.remodelLiving,
      NWS_IMAGES.remodelDetail,
      NWS_IMAGES.additionAfter,
  ...
  },
  {
    ...
    heroImage: NWS_IMAGES.customHomeDetail,
    galleryImages: [
      NWS_IMAGES.customHomeDetail,
      NWS_IMAGES.customHome,
      NWS_IMAGES.additionBefore,
  ...
  },
  {
    ...
    heroImage: NWS_IMAGES.remodelDetail,
    galleryImages: [
      NWS_IMAGES.remodelDetail,
      NWS_IMAGES.remodelLiving,
      NWS_IMAGES.customHome,
  ...
  },
  {
    ...
    heroImage: NWS_IMAGES.remodelBath,
    galleryImages: [
      NWS_IMAGES.remodelBath,
      NWS_IMAGES.bath,
      NWS_IMAGES.remodelDetail,
